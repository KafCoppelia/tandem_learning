...
from models.cifar10 import CifarNet, CifarNetSmall, CifarNetSmallIF
...
if __name__ == '__main__':
    ...
    model = CifarNetSmallIF(neuronParam, Tencode)
    # model = CifarNetSmall()
    # model = CifarNet()
    ...
    for epoch in range(num_epochs):
        ...
        if acc_test >= best_acc_snn:
            ...
            torch.save(state, ckp_dir + f'if_small_tencode{Tencode}_ckp.pt')
